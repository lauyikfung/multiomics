...
for THRESHOLD in THRESHOLDS:
    ...
    for item in community_list_sketch:
        ...
        sorted_cnt = sorted_cnt + 1
    import json
    with open("./tight/result_tight_"+str(THRESHOLD)+"_.json", "w") as f:
        json.dump(community_list, f)
    with open("./tight/result_sketch_tight_"+str(THRESHOLD)+"_.json", "w") as f:
    ...
    igraph.save(g, './tight/subGraph_tight_'+str(THRESHOLD)+'_.graphml')
